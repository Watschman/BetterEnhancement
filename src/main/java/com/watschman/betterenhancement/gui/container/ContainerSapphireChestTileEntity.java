...
public class ContainerSapphireChestTileEntity extends Container {
    private final int xSize = 184;
    private final int ySize = 238;
    private final int col = (xSize - 162) / 2 + 1;

    private SapphireChestTileEntity tileEntity;

    public ContainerSapphireChestTileEntity(IInventory playerInv, SapphireChestTileEntity tileEntity){
