...
public class ContainerRubyChestTileEntity extends Container {
    private final int xSize = 184;
    private final int ySize = 238;
    private final int col = (xSize - 162) / 2 + 1;

    private RubyChestTileEntity tileEntity;

    public ContainerRubyChestTileEntity(IInventory playerInv, RubyChestTileEntity tileEntity){
