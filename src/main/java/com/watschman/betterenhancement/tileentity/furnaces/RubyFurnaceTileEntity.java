...
public class RubyFurnaceTileEntity extends TileEntityLockable implements ITickable, ISidedInventory{
    ...
    {
        return this.hasCustomName() ? this.furnaceCustomName : "container.ruby_furnace";
    }
    ...
    public void update()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                RubyFurnace.setState(this.isBurning(), this.worldObj, this.pos);
            }
        }
