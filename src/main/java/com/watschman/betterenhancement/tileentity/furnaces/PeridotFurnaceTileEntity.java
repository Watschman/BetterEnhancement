...
public class PeridotFurnaceTileEntity extends TileEntityLockable implements ITickable, ISidedInventory{
    ...
    {
        return this.hasCustomName() ? this.furnaceCustomName : "container.peridot_furnace";
    }
    ...
    public void update()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                PeridotFurnace.setState(this.isBurning(), this.worldObj, this.pos);
            }
        }
