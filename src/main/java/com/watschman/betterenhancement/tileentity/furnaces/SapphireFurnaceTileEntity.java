package com.watschman.betterenhancement.tileentity.furnaces;
...
public class SapphireFurnaceTileEntity extends TileEntityLockable implements ITickable, ISidedInventory{
    ...
    {
        return this.hasCustomName() ? this.furnaceCustomName : "container.sapphire_furnace";
    }
    ...
    public void update()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                SapphireFurnace.setState(this.isBurning(), this.worldObj, this.pos);
            }
        }
