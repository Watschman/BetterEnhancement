package com.watschman.betterenhancement.entity.passive;

import com.google.common.collect.Sets;
import java.util.Set;
import javax.annotation.Nullable;

import com.watschman.betterenhancement.entity.LootTables;
...
public class EntitySapphirePig extends EntityAnimal
{
    private static final DataParameter<Boolean> SADDLED = EntityDataManager.<Boolean>createKey(EntitySapphirePig.class, DataSerializers.BOOLEAN);
    ...
    public EntitySapphirePig(World worldIn)
    {
        super(worldIn);
    ...
    {
        return LootTables.ENTITIES_SAPPHIRE_PIG;
    }
    ...
    public EntitySapphirePig createChild(EntityAgeable ageable)
    {
        return new EntitySapphirePig(this.worldObj);
    }
