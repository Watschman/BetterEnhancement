...
public class EntityPeridotPig extends EntityAnimal
{
    private static final DataParameter<Boolean> SADDLED = EntityDataManager.<Boolean>createKey(EntityPeridotPig.class, DataSerializers.BOOLEAN);
    ...
    public EntityPeridotPig(World worldIn)
    {
        super(worldIn);
    ...
    {
        return LootTables.ENTITIES_PERIDOT_PIG;
    }
    ...
    public EntityPeridotPig createChild(EntityAgeable ageable)
    {
        return new EntityPeridotPig(this.worldObj);
    }
