...
public class EntityRubyPig extends EntityAnimal
{
    private static final DataParameter<Boolean> SADDLED = EntityDataManager.<Boolean>createKey(EntityRubyPig.class, DataSerializers.BOOLEAN);
    ...
    public EntityRubyPig(World worldIn)
    {
        super(worldIn);
    ...
    {
        return LootTables.ENTITIES_RUBY_PIG;
    }
    ...
    public EntityRubyPig createChild(EntityAgeable ageable)
    {
        return new EntityRubyPig(this.worldObj);
    }
